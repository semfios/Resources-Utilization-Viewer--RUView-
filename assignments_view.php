...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV=array(   
		...
		"IF(    CHAR_LENGTH(`projects1`.`StartDate`) || CHAR_LENGTH(`projects1`.`EndDate`), CONCAT_WS('',   `projects1`.`StartDate`, ' <b>to</b> ', `projects1`.`EndDate`), '') /* Project Duration */" => "ProjectDuration",
	...
	$x->QueryFieldsFilters=array(   
		...
		"IF(    CHAR_LENGTH(`projects1`.`StartDate`) || CHAR_LENGTH(`projects1`.`EndDate`), CONCAT_WS('',   `projects1`.`StartDate`, ' <b>to</b> ', `projects1`.`EndDate`), '') /* Project Duration */" => "Project Duration",
